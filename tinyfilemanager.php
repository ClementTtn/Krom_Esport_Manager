...
$CONFIG = '{"lang":"fr","error_reporting":false,"show_hidden":false,"hide_Cols":true,"calc_folder":false,"theme":"dark"}';
...
if (isset($_GET['logout'])) {
    ...
    fm_redirect('https://setup.krom-esport.fr/');
}
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                            ...
                            <div class="card-body">
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    <div class="form-group">
                                       <div class="brand">
                                           <img src="https://www.krom-esport.fr/img/logos/krom_logo.png" alt="">
                                        </div>
                                        <br>
                                        <div class="text-center">
                                            <h1 class="card-title">KROM Esport Manager</h1>
                                        </div>
                                    </div>
                                    <hr />
                                    <div class="form-group">
                                        <label for="fm_usr"><?php echo lng('Identifiant'); ?></label>
                                        <input type="text" class="form-control" id="fm_usr" name="fm_usr" required autofocus>
                                    </div>

                                    <div class="form-group">
                                        <label for="fm_pwd"><?php echo lng('Mot de passe'); ?></label>
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a href="https://tinyfilemanager.github.io/" target="_blank" class="text-muted" data-version="<?php echo VERSION; ?>">CCP Programmers - Tiny File Manager</a> &mdash;&mdash;
                            <br>
                            &mdash;&mdash;
                            <a href="https://www.krom-esport.fr/" target="_blank" class="text-muted">Réagencé par KROM Esport</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
...
<head>
    ...
    <meta name="description" content="Gestionnaire de fichiers de KROM Esport.">
    <meta name="author" content="CCP Programmers, KROM Esport">
    <meta name="robots" content="noindex, nofollow">
    <meta name="googlebot" content="noindex">
    <title>KROM Esport Manager</title>
    <link rel="icon" type="image/x-icon" href="https://www.krom-esport.fr/img/logos/favicon.png">
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">
    <style>
        body.fm-login-page{ background-color: rgba(0,0,0,0.5);font-size:14px;background-color:rgba(0,0,0,0.5);background-image: url("https://www.krom-esport.fr/img/header/background_manager.webp");}
        ...
        .card{background-color: rgba(0,0,0,0.5); backdrop-filter: blur(5px); -webkit-backdrop-filter: blur(5px);}
        .card-wrapper{color: white;}
        .btn-success{background-color: rgba(222, 254, 54, 1); color: black; border: 3px solid black; -webkit-transition: all 0.25s ease-in-out; transition: all 0.25s ease-in-out;}
        .btn-success:hover{background-color: rgba(0,0,0,0.5); color: rgba(222, 254, 54, 1); border: 3px solid rgba(222, 254, 54, 1); -webkit-transition: all 0.25s ease-in-out;}
...
<head>
    ...
    <?php endif; ?>
    <style>
        body { font-size:14px;color:#222;background-color: #fff; }
        ...
        * { -webkit-border-radius:0 !important;-moz-border-radius:0 !important;border-radius:0 !important; }
        ...
        .inline-actions > a > i { font-size:1em;margin-left:5px;background:rgba(222, 254, 54, 1);color:black;padding:3px;border-radius:3px  }
    ...
    if (FM_THEME == "dark"): ?>
        <style>
            body.theme-dark { background-color: #2a2a2a; }
            .list-group .list-group-item { background: #343a40; }
            .theme-dark .navbar-nav i, .navbar-nav .dropdown-toggle, .break-word { color: #ffffff; }
            a, a:hover, a:visited, a:active, #main-table .filename a { color: white; }
            ul#search-wrapper li:nth-child(odd) { background: #f9f9f9cc; }
            .theme-dark .btn-outline-primary { color: rgba(222, 254, 54, 1); border-color: rgba(222, 254, 54, 1); }
            .theme-dark .btn-outline-primary:hover, .theme-dark .btn-outline-primary:active { background-color: rgba(222, 254, 54, 1);}
        </style>
    <?php endif; ?>
</head>
